...
public class QueryMain {
    ...
    public static void main(String[] args) {
        ...
        boolean buffersNeeded = sqlquery.isDistinct() || !sqlquery.getOrderByList().isEmpty();
        configureBufferManager(buffersNeeded,sqlquery.getNumJoin() , args, in);
     ...
     **/
    private static void configureBufferManager(boolean buffersNeeded, int numJoin, String[] args, BufferedReader in) {
        if (buffersNeeded || numJoin != 0) {
            int numBuff = 1000;
            if (args.length < 4) {

...
public class Scan extends Operator {
    ...
    public boolean open() {
        ...
        if (batchsize < 1) { // added a check if the size of the tuple is greater than the page size!
            throw new IllegalArgumentException("The tuple size is greater than the page size! ");
        }
        eos = false;
        try {
